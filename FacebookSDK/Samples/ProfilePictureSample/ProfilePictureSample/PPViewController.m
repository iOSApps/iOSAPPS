...
- (IBAction)showJasonProfile:(id)sender {
    ...
    profilePictureView.profileID = @"100000253922958";
}
...
- (IBAction)showVijayeProfile:(id)sender {
    profilePictureView.profileID = @"sandyreddychalla";
}
...
- (void)viewDidLoad {
    ...
    NSLog(@"ids size is%ld ",sizeof(interestingIDs));
    NSLog(@"zero id size is %ld",sizeof(interestingIDs[0]));
    
    NSLog(@"id is %d",kNumInterestingIDs);
    profilePictureView.profileID = @"100000253922958"; //@"45963418107"; // Hello world
}
