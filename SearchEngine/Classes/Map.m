 ...
 */
mapview=[[mapview alloc]initWithFrame:self.view.bounds]; //mapview=[[MKMapView alloc]initWithFrame:self.view.bounds];//self.view.bounds->to fix mapview in view
mapview.mapType=MKMapTypeHybrid;
...
/*-(void)displayMYMap
 ...
 location.latitude =12.9786614;
 location.longitude =77.5723962;
...
/*
 ...
 NSString *lat=[[NSString alloc]initWithFormat:@"%@",map1];
 NSString *lng=[[NSString alloc]initWithFormat:@"%@",map2];
 NSString *acc=[[NSString 
 }
 */
